...
import sthumb from "public/images/testimonial/loogo.jpeg";
import sthumbtwo from "public/images/testimonial/annni.jpeg";
import sthumbthree from "public/images/testimonial/thummbb.jpeg";

const HomeTestinomial2 = () => {
                      ...
                      <div className="col-12 col-lg-7 offset-lg-1 col-xxl-7 offset-xxl-1">
                        <div className="testimonial-s__content">
                          ...
                          <div className="content">
                            <h4>
                            The digital marketing solutions provided by <span style={{color: "yellow"}}>Softway Design</span> helped us rank at the top of search results. Their expertise and dedication are unparalleled
                            </h4>
                          </div>
                          <div className="content-cta">
                            <h5>Jane Smith</h5>
                            <p>Founder of Creative Studios</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row gaper align-items-center">
                      ...
                      <div className="col-12 col-lg-7 offset-lg-1 col-xxl-7 offset-xxl-1">
                        <div className="testimonial-s__content">
                          ...
                          <div className="content">
                            <h4>
                            Their team not only delivered excellent results but also educated us about the process, which built trust and confidence in their expertise!
                            </h4>
                          </div>
                          <div className="content-cta">
                            <h5>Sarah White</h5>
                            <p>Co-Founder of Elite Ventures</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row gaper align-items-center">
                      ...
                      <div className="col-12 col-lg-7 offset-lg-1 col-xxl-7 offset-xxl-1">
                        <div className="testimonial-s__content">
                          ...
                          <div className="content">
                            <h4>
                            We’ve partnered with several digital marketing agencies, but <span style={{color: "yellow"}}>Softway Design</span> truly stands out with their personalized approach and consistent results!
                            </h4>
                          </div>
                          <div className="content-cta">
                            <h5>Emma Martinez</h5>
                            <p>CMO at EcoSolutions</p>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default HomeTestinomial2;
